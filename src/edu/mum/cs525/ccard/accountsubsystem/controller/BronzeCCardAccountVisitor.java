...
import edu.mum.cs525.ccard.accountsubsystem.model.BronzeCCard;
...
public class BronzeCCardAccountVisitor extends AccountVisitor{
    ...
    public IAccount createAccount(IPerson person, String accountNumber) {
        return new BronzeCCard( person,accountNumber, new PersonEvaluatorFunctor());
    }

    @Override
    public IAccount createAccount(ICompany company, String accountNumber) {
        return new BronzeCCard(company,accountNumber, new CompanyEvaluatorFunctor());
    }
}
