 ...
 */
public class BronzCCard extends CCardAccount {
    public BronzCCard(ICustomer accountOwner, String accountNumber, double accountInterestRate, EvaluateFunctor evaluateFunctor) {
        super(accountOwner, accountNumber, accountInterestRate, evaluateFunctor);
    }

    public BronzCCard(ICustomer accountOwner, String accountNumber, EvaluateFunctor evaluateFunctor) {
